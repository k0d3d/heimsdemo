...
#
NAME="Integra DrugStoc App"
NODE_BIN_DIR=/usr/bin/node
NODE_PATH=/usr/lib/node_modules
APPLICATION_DIRECTORY=/var/www/html
APPLICATION_START=server.js
PIDFILE=/var/run/drugstoc.pid
LOGFILE=/var/www/html/log/log.log
ERRLOG=/var/www/html/log/err.log
OUTLOG=/var/www/html/log/output.log
...
start() {
    ...
    forever --pidFile $PIDFILE --sourceDir $APPLICATION_DIRECTORY \
        -a -l $LOGFILE -e $ERRLOG -o $OUTLOG --minUptime 5000 --spinSleepTime 2000 \
